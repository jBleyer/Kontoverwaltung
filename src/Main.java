...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            System.out.println("\nWas moechten Sie machen? 1 - anlegen, 2 - einzahlen, 3 - abheben, 4 - auszug, 5 - aufloesen, 6 - ueberweisen, q - quit");
            if (konten.size() == 0) {
            ...
            switch (input) {
                case '1':
                    ...
                    if (kontoart == '1') {
                        ...
                        girokonto.anlegen("Inhaber-Girokonto", 19043, "00234569773", 0.0f, 6.0f, 300.0f, "Girokonto");
                        ...
                        sparkonto.anlegen("Inhaber-Sparkonto", 24860, "09877384842", 0.0f, 0.0f, 1200.0f, "Sparkonto");
                ...
                //I tried aber ich denk zu kompliziert
                
                case '6':
                    //überweisen
                    if (konten.size() == 0) {
                        System.out.println("Legen Sie bitte zuerst ein Konto an!");
                        break;
                    }

                    System.out.println("Bitte geben Sie die Kontonummer des Kontos ein, von welchem Sie eine Ueberweisung taetigen.");
                    String buffer5 = scanner.nextLine();
                    String kontonummerInputUeberweisen1 = scanner.nextLine();
                    System.out.println("Bitte geben Sie die Kontonummer des Kontos ein, auf welches Sie einen Betrag ueberweisen.");
                    String buffer6 = scanner.nextLine();
                    String kontonummerInputUeberweisen2 = scanner.nextLine();

                    Konto k1;
                    Konto k2;

                    for (int i = 0; i < konten.size(); i++) {
                        if (kontonummerInputUeberweisen1.equals(konten.get(i).getKontonummer())) {

                            k1 = konten.get(i);
                            break;
                        } else if (kontonummerInputUeberweisen2.equals(konten.get(i).getKontonummer())) {
                            k2 = konten.get(i);
                            break;
                        }
